...
const FILIERES: { titre:string; lignes:Concours[] }[] = [
  ...
  },
  {
    ...
    lignes: [
      ...
      { slug:"aide-soignant-guadeloupe", concours:"Aide-soignant de classe normale", cat:"B", type:"Concours", inscriptions:"16 mars → 21 avril 2027", epreuves:"Automne 2027 (à confirmer)", statut:"bientot" },

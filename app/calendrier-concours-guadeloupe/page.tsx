...
const FILIERES: { titre:string; lignes:Concours[] }[] = [
  ...
  },
  {
    ...
    lignes: [
      ...
      { slug:"aide-soignant-guadeloupe", concours:"Aide-soignant de classe normale", cat:"B", type:"Concours", inscriptions:"Session 2027 — dates à confirmer", epreuves:"À confirmer (CDG 971)", statut:"bientot" },

        ...
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 24px", display:"flex", alignItems:"center", justifyContent:"space-between", height:68 }}>
          ...
          <nav style={{ display:"flex", gap:4, alignItems:"center" }}>
            {([["Formations","/formations"],["Notre Méthode","/notre-methode"],["Calendrier","/calendrier-concours-guadeloupe"],["Témoignages","/temoignages-laureats"],["Tarifs & CPF","/financement-tarifs"],["Contact","/contact"]] as [string,string][]).map(([label,href]) => (
              <Link key={href} href={href} style={{ color:href==="/calendrier-concours-guadeloupe"?"white":"rgba(255,255,255,0.8)", fontSize:13, fontWeight:href==="/calendrier-concours-guadeloupe"?700:500, padding:"6px 12px", borderRadius:6, textDecoration:"none", whiteSpace:"nowrap", borderBottom:href==="/calendrier-concours-guadeloupe"?"2px solid #F5A623":"none" }}>{label}</Link>
            ))}

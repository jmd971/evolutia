        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
          ...
          <nav style={{ display: "flex", gap: 4, alignItems: "center" }}>
            {([
              ...
              <Link key={href} href={href} style={{ color: href === "/contact" ? "white" : "rgba(255,255,255,0.8)", fontSize: 13, fontWeight: href === "/contact" ? 700 : 500, padding: "6px 12px", borderRadius: 6, textDecoration: "none", whiteSpace: "nowrap", borderBottom: href === "/contact" ? "2px solid #F5A623" : "none" }}>
                {label}
              </Link>
            ))}
